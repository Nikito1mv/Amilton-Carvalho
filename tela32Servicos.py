...
class Tela42:
    def __init__(self):
        ...
        self.titulo = Label(self.frame1, text="Lista de Serviços",
                            bg="black", fg="white", font=("Calibri", 18, "bold"), width=25)
        self.titulo.grid(row=0, padx=20, pady=10)

        "Frame_Logo=============================================================="

        #elf.imgLogo = PhotoImage(file="Imagens\\amiltonCarvalhoLogo.png")
        ...
        self.frameDados = Frame(self.frame1, bg="")
        ...
        self.botaoProcurar = Button(self.frameBotoes, text="Buscar", command=self.buscarServicosM, bg="red", fg="white", font=(
        ...
        self.labId = Label(self.frameBotoes, text="ID:",
                           bg="black", fg="white", font=("Calibri", 13, "bold"))
        self.labId.grid(row=0, column=3, padx=10, pady=10)

        self.entId = Entry(
            self.frameBotoes, textvariable=self.digId, font=("Calibri", 13), width=5)
        self.entId.grid(row=0, column=4, padx=10, pady=10)

        self.botaoAdd = Button(self.frameBotoes, command=self.addComfirmar, text="Marcar como Concluído",
    ...
    def pegarDados(self, event):
        ...
        self.digId.set(linha[0])
        self.digNome.set(linha[1])
        self.digPlaca.set(linha[2])
        self.digServico.set(linha[3])
