...
class Tela41:
    def __init__(self):
        ...
        self.titulo = Label(self.frame1, text="Cadastramento de Orçamentos",
        ...
        self.botaoProcurar = Button(self.frameBotoes, text="Buscar", command=self.buscarOrcamentos, bg="red", fg="white", font=(
        ...
        self.botaoInserir = Button(self.frameBotoes, text="Adicionar Orçamento", command=self.adicionarOrcamentos,
        ...
        self.botaoAtualizar = Button(self.frameBotoes, text="Alterar Orçamento", command=self.editarOrcamentos,
        ...
        self.botaoDeletar = Button(self.frameBotoes, text="Excluir Orçamento", command=self.deletarOrcamentos,
                                   bg="red", fg="white", font=("Calibri", 13, "bold"), relief=RAISED, overrelief=RIDGE, width=20)
        self.botaoDeletar.grid(row=0, column=4, padx=10, pady=10)

        "Frame_Botões_2=============================================================="

        self.frameBotoes2 = Frame(self.frame1, bg="black")
        self.frameBotoes2.grid(row=3, column=0, pady=20)
        ...
        self.botaoLimpar.grid(row=0, column=0, padx=10, pady=10)

        self.botaoComfirmarServico = Button(self.frameBotoes2, text="Comfirmar como Serviço", command=self.comfirmarServico,
                                            bg="red", fg="white", font=("Calibri", 13, "bold"), relief=RAISED, overrelief=RIDGE, width=23)
        self.botaoComfirmarServico.grid(row=1, column=0, padx=10, pady=15)
    ...
    def buscarOrcamentos(self):
        self.tv.delete(*self.tv.get_children())
        linhas = banco.searchOrcamentos(self.entNome.get(), self.entPlaca.get(
        ), self.entTelefone.get(), self.entEmail.get(), self.entServico.get())
        for i in linhas:
            self.tv.insert("", END, values=i)

    def comfirmarServico(self):
        if (self.entNome.get() == "" or self.entPlaca.get() == "" or self.entTelefone.get() == "" or self.entEmail.get() == "" or self.entServico.get() == ""):
            messagebox.showwarning(
                "Erro na entrada", "Por favor, preencha todos os campos")
        else:
