...
class Tela22:
    def __init__(self):
        ...
        self.janela22.title("Amilton Carvalho")
        self.janela22.geometry("1366x768")
        self.janela22.config(bg="black")
        self.janela22.state("zoomed")
        ...
        self.frame1 = Frame(self.janela22, bg="black")
        self.frame1.grid(row=0, column=0, padx=5, sticky="n")

        self.frame2 = Frame(self.janela22, bg="black")
        self.frame2.grid(row=0, column=1)

        "Frame_Título=============================================================="

        self.titulo = Label(self.frame1, text="Gerenciamento de Orçamentos",
