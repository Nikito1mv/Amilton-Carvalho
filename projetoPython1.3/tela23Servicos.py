...
class Tela23:
    def __init__(self):
        ...
        self.janela23.title("Amilton Carvalho")
        self.janela23.geometry("1366x768")
        self.janela23.config(bg="black")
        self.janela23.state("zoomed")
        ...
        self.frame1 = Frame(self.janela23, bg="black")
        self.frame1.grid(row=0, column=0, padx=5, sticky="n")

        self.frame2 = Frame(self.janela23, bg="black")
        self.frame2.grid(row=0, column=1)

        "Frame_Título=============================================================="

        self.titulo = Label(self.frame1, text="Gerenciamento de Serviços",
        ...
        self.botaoInserir = Button(self.frameBotoes, text="Inserir Serviço", command=self.adicionarServicos,
